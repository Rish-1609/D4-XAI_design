...
export class MemStorage implements IStorage {
  ...
  private async initializeDummyData() {
    ...
    const productionBatchData: ProductionBatch[] = [
      {
        ...
        isDelayed: false,
        delayReason: null,
        masterBatchRecordId: "MBR-PARA-001",
        equipmentIds: ["EQ-COMP-001", "EQ-BLEND-001"],
        gmpVersion: "21 CFR Part 211",
        environmentalConditions: "Temp: 22°C, RH: 45%",
        createdBy: "Production Manager",
      ...
      },
      {
        ...
        isDelayed: false,
        delayReason: null,
        masterBatchRecordId: "MBR-AMOX-001",
        equipmentIds: ["EQ-CAP-001"],
        gmpVersion: "21 CFR Part 211",
      ...
      },
      {
        ...
        isDelayed: false,
        delayReason: null,
        masterBatchRecordId: "MBR-CEFU-001",
        equipmentIds: ["EQ-MIX-001", "EQ-FILL-001"],
        gmpVersion: "21 CFR Part 211",
        environmentalConditions: "Temp: 20°C, RH: 40%",
        createdBy: "Production Manager",
      ...
      },
      {
        ...
        masterBatchRecordId: "MBR-IBUP-001",
        equipmentIds: ["EQ-COAT-001", "EQ-COMP-002"],
        gmpVersion: "21 CFR Part 211",
        environmentalConditions: "Temp: 23°C, RH: 50%",
        createdBy: "Production Manager",
      ...
      },
      {
        ...
        isDelayed: false,
        delayReason: null,
        masterBatchRecordId: "MBR-CEFT-001",
        equipmentIds: ["EQ-STER-001"],
        gmpVersion: "21 CFR Part 211",
        environmentalConditions: null,
        createdBy: "Production Manager",
    ...
    const batchStageData: BatchStage[] = [
      ...
      { id: "bs1", batchId: "pb1", stageName: "Dispensing", stageOrder: 1, status: "completed", plannedStartTime: new Date('2024-12-01T08:00:00'), plannedEndTime: new Date('2024-12-01T12:00:00'), actualStartTime: new Date('2024-12-01T08:15:00'), actualEndTime: new Date('2024-12-01T11:45:00'), assignedTo: "John Smith", equipmentId: "EQ-DISP-001", notes: "All materials dispensed as per BOM", createdAt: new Date('2024-12-01'), updatedAt: new Date('2024-12-01') },
      { id: "bs2", batchId: "pb1", stageName: "Sifting", stageOrder: 2, status: "completed", plannedStartTime: new Date('2024-12-01T13:00:00'), plannedEndTime: new Date('2024-12-01T15:00:00'), actualStartTime: new Date('2024-12-01T13:00:00'), actualEndTime: new Date('2024-12-01T14:45:00'), assignedTo: "Mike Johnson", equipmentId: "EQ-SIFT-001", notes: "40 mesh sieve used", createdAt: new Date('2024-12-01'), updatedAt: new Date('2024-12-01') },
      { id: "bs3", batchId: "pb1", stageName: "Dry Mixing", stageOrder: 3, status: "completed", plannedStartTime: new Date('2024-12-02T08:00:00'), plannedEndTime: new Date('2024-12-02T10:00:00'), actualStartTime: new Date('2024-12-02T08:00:00'), actualEndTime: new Date('2024-12-02T09:50:00'), assignedTo: "Sarah Lee", equipmentId: "EQ-MIX-002", notes: "Blend uniformity achieved", createdAt: new Date('2024-12-02'), updatedAt: new Date('2024-12-02') },
      { id: "bs4", batchId: "pb1", stageName: "Granulation", stageOrder: 4, status: "completed", plannedStartTime: new Date('2024-12-02T10:30:00'), plannedEndTime: new Date('2024-12-02T14:00:00'), actualStartTime: new Date('2024-12-02T10:30:00'), actualEndTime: new Date('2024-12-02T14:15:00'), assignedTo: "Sarah Lee", equipmentId: "EQ-GRAN-001", notes: "Wet granulation completed", createdAt: new Date('2024-12-02'), updatedAt: new Date('2024-12-02') },
      { id: "bs5", batchId: "pb1", stageName: "Drying", stageOrder: 5, status: "completed", plannedStartTime: new Date('2024-12-03T08:00:00'), plannedEndTime: new Date('2024-12-03T12:00:00'), actualStartTime: new Date('2024-12-03T08:00:00'), actualEndTime: new Date('2024-12-03T11:30:00'), assignedTo: "Mike Johnson", equipmentId: "EQ-FBD-001", notes: "LOD: 2.1%", createdAt: new Date('2024-12-03'), updatedAt: new Date('2024-12-03') },
      { id: "bs6", batchId: "pb1", stageName: "Compression", stageOrder: 6, status: "in-progress", plannedStartTime: new Date('2024-12-04T08:00:00'), plannedEndTime: new Date('2024-12-04T18:00:00'), actualStartTime: new Date('2024-12-04T08:00:00'), actualEndTime: null, assignedTo: "David Chen", equipmentId: "EQ-COMP-001", notes: "Compression in progress, 35000 tablets done", createdAt: new Date('2024-12-04'), updatedAt: new Date('2024-12-10') },
      { id: "bs7", batchId: "pb1", stageName: "Coating", stageOrder: 7, status: "pending", plannedStartTime: new Date('2024-12-05T08:00:00'), plannedEndTime: new Date('2024-12-05T14:00:00'), actualStartTime: null, actualEndTime: null, assignedTo: "Emily Wang", equipmentId: "EQ-COAT-001", notes: null, createdAt: new Date('2024-12-04'), updatedAt: new Date('2024-12-04') },
      { id: "bs8", batchId: "pb1", stageName: "Packaging", stageOrder: 8, status: "pending", plannedStartTime: new Date('2024-12-05T14:30:00'), plannedEndTime: new Date('2024-12-05T18:00:00'), actualStartTime: null, actualEndTime: null, assignedTo: "Robert Kim", equipmentId: "EQ-PACK-001", notes: null, createdAt: new Date('2024-12-04'), updatedAt: new Date('2024-12-04') },
      // Stages for BTH-2024-004 (Ibuprofen - QC Hold)
      { id: "bs9", batchId: "pb4", stageName: "Dispensing", stageOrder: 1, status: "completed", plannedStartTime: new Date('2024-12-08T08:00:00'), plannedEndTime: new Date('2024-12-08T12:00:00'), actualStartTime: new Date('2024-12-08T08:00:00'), actualEndTime: new Date('2024-12-08T11:30:00'), assignedTo: "John Smith", equipmentId: "EQ-DISP-001", notes: "Dispensing complete", createdAt: new Date('2024-12-08'), updatedAt: new Date('2024-12-08') },
      { id: "bs10", batchId: "pb4", stageName: "Compression", stageOrder: 2, status: "completed", plannedStartTime: new Date('2024-12-09T08:00:00'), plannedEndTime: new Date('2024-12-09T18:00:00'), actualStartTime: new Date('2024-12-09T08:00:00'), actualEndTime: new Date('2024-12-09T17:30:00'), assignedTo: "David Chen", equipmentId: "EQ-COMP-002", notes: "72000 tablets compressed", createdAt: new Date('2024-12-09'), updatedAt: new Date('2024-12-09') },
      { id: "bs11", batchId: "pb4", stageName: "Coating", stageOrder: 3, status: "qc-hold", plannedStartTime: new Date('2024-12-10T08:00:00'), plannedEndTime: new Date('2024-12-10T14:00:00'), actualStartTime: new Date('2024-12-10T08:00:00'), actualEndTime: null, assignedTo: "Emily Wang", equipmentId: "EQ-COAT-001", notes: "QC hold - coating solution viscosity deviation", createdAt: new Date('2024-12-10'), updatedAt: new Date('2024-12-10') },
    ];

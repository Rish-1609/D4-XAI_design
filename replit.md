...
- **Master Data Management**: "Master" sidebar section with 6 sub-pages:
  ...
  - `/master-material` — Material Master with 40 pharma materials: 15 APIs (Ofloxacin, Ornidazole, Nimesulide, Paracetamol, Pantoprazole, Cefixime, Levofloxacin, Metformin, Amoxycillin, Clavulanic Acid, Atorvastatin, Rabeprazole, Domperidone, DOLO-650), 10 excipients (MCC PH102, Croscarmellose Sodium, HPMC E5, Starch Maize IP, Magnesium Stearate, Talc IP, SiO2, Lactose, PVP K30, Isomalt), 8 packaging materials, 10 finished goods; columns: code, name, type, category, UOM, pharmacopoeial standard, storage condition, shelf life, reorder level/qty, HS code, CAS number, Schedule H indicator; SOP: MAT-001
...
- **Location Hierarchy** (in `/inventory-master` Handling Units page, "Location Directory" tab): Full 3-warehouse expandable hierarchy (WH-001 Raw Materials / WH-002 Packaging / WH-003 Finished Goods) → Zones → Aisles/Bays with temperature, capacity, HU count, RFID reader count columns; expand/collapse/search; 35 locations defined
